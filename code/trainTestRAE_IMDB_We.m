...
params.CVNUM = 1;
preProFile = ['../data/IMDB_We/RTData_CV' num2str(params.CVNUM) '.mat'];

% read in polarity dataset
if ~exist(preProFile,'file')
    read_rtPolarity_IMDB_We;
else
    global bKnownParses;
    if(bKnownParses)
...
%%%%%%%%%%%%%%%%%%%%%%
theta = initializeParameters_We(params.embedding_size, params.embedding_size, cat_size);
