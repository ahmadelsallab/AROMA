...
copyfile(['vocab_ArSenL_Embedding.mat'], [RAEPath '\data\ATB_ArSenL_Embedding\'], 'f');
...
copyfile(['final_net_ArSenL_embedding.mat'], [RAEPath '\data\ATB_ArSenL_Embedding\'], 'f');
movefile([RAEPath '\data\ATB_ArSenL_Embedding\final_net_ArSenL_embedding.mat'], [RAEPath '\data\ATB_ArSenL_Embedding\final_net.mat'], 'f');
copyfile(['input_data_ArSenL_Embedding_1.mat'], [RAEPath '\data\ATB_ArSenL_Embedding\'], 'f');
