...
% Last Modified by GUIDE v2.5 14-Oct-2015 12:57:43
...
function sParseFilePath_Callback(hObject, eventdata, handles)
% hObject    handle to sParseFilePath (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of sParseFilePath as text
%        str2double(get(hObject,'String')) returns contents of sParseFilePath as a double
