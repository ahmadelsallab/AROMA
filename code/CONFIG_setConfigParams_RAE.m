...
function CONFIG_setConfigParams_RAE()
    ...
    CONFIG_strParams.sExperimentPurpose = 'RAE with word2vec embeddings from the 50% QALB';
    ...
    CONFIG_strParams.bKnownVocabulary = 1;
        ...
        CONFIG_strParams.sVocabularyFile = '..\..\Datasets\Embedding files\Qalb_ATB\50\vocab.mat';
...
%           % N-gram validity We
           CONFIG_strParams.bNgramValidWe = 1;
            CONFIG_strParams.bConvertWord2Vec = 1;
           
%               
%               % The name of N-gram validity workspace
               CONFIG_strParams.sNgramValidWorkspaceName = '..\..\Datasets\Embedding files\Qalb_ATB\50\We.mat';
%               
