...
file1 = '../data/ATB_We/rt-polarity.pos';
fid1 = fopen(file1);

%file2 = '../data/rt-polaritydata/rt-polarity.neg';
file2 = '../data/ATB_We/rt-polarity.neg';
fid2 = fopen(file2);
...
load('../data/ATB_We/rt-polarity_pos_binarized.mat','allSNum','allSStr');
allSNum_pos = allSNum;
allSStr_pos = allSStr;

%load('../data/rt-polaritydata/rt-polarity_neg_binarized.mat','allSNum','allSStr');
load('../data/ATB_We/rt-polarity_neg_binarized.mat','allSNum','allSStr');
