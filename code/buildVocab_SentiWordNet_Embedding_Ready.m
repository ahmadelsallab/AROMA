function [words, allSStr, allSNum] = buildVocab_SentiWordNet_Embedding_Ready(txtFileName, indicesFileName, annotationsFileName, knownParseFileName)
    ...
    file_pos = '../data/IMDB_SentiWordNet_Embedding/rt-polarity.pos';
    fid_pos = fopen(file_pos, 'w', 'n', 'UTF-8');

    file_neg = '../data/IMDB_SentiWordNet_Embedding/rt-polarity.neg';
    fid_neg = fopen(file_neg, 'w', 'n', 'UTF-8');

    file_all = '../data/IMDB_SentiWordNet_Embedding/rt-polarity.all';
    ...
    %%% NEW
    %labels = labels';
    %save('../data/IMDB_SentiWordNet_Embedding/rt-polarity_binarized.mat','allSNum','allSStr', 'labels');%%%
    %%%%
