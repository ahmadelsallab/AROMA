...
function CONFIG_setConfigParams_RAE_Bare()
    global CONFIG_strParams;
    
    % State the experiment purpose
    CONFIG_strParams.sExperimentPurpose = 'Default: Test basic RAE, no classification\n';
    ...
    CONFIG_strParams.eClassifierType = 'RAE_Bare';
    
    % Configuration of the dataset to be used
    % ATB_Senti_RAE
	% Movie_Reviews
	% IMDB: Not functional
    CONFIG_strParams.sDataset = 'RAE_Bare';
    ...
    CONFIG_strParams.bWordEmbedding = 1;
...
%               % The name of N-gram validity workspace
               CONFIG_strParams.sNgramValidWorkspaceName = '../data/RDI/We.mat';
%               
...
%             % The name of the embedding workspace
             CONFIG_strParams.sLexiconEmbeddingWorkspaceName = '';
...
%         % Get the path to the known parse trees
    ...
    % Results files
    CONFIG_strParams.sResultsFile = '../output/RDI/resultsRAE.txt';
    CONFIG_strParams.sRAETrainedParamsWorkspace = '../data/RDI/RAEWeights.mat';
    CONFIG_strParams.sDataSplitWorkspace = '../data/RDI/dataSplits.mat';
    CONFIG_strParams.sRAERepresentationsWorkspace = '../output/RDI/RAE_representations.mat';
