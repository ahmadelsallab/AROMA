...
load('../data/Qalb/vocab.mat','words_Qalb')
words = words_Qalb;
...
load('../data/Qalb/rt-polarity_Qalb_binarized.mat','allSNum_Qalb','allSStr_Qalb');
allSNum = allSNum_Qalb;
allSStr = allSStr_Qalb;



num_examples = length(allSNum_Qalb);
...
save(preProFile_Qalb,'We2','allSNum_Qalb','unq','isnonZero');
