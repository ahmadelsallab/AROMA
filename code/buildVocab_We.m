function [words, allSStr, allSNum] = buildVocab_We(txtFileName, annotationsFileName, knownParseFileName)
...
if(bKnownParses)
    ...
    save('../data/ATB_We/rt-polarity_pos_binarized.mat','allSNum','allSStr', 'allKids_pos');
    ...
    % Save the positive workspace
    save('../data/ATB_We/rt-polarity_neg_binarized.mat','allSNum','allSStr', 'allKids_neg');
