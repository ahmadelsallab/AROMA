...
function MAIN_trainRAE()    
	...
	switch(CONFIG_strParams.sDataset)
        case 'RAE_Bare'
			...
			[cData, cUnsupervisedData, cKids, cUnsupervisedKids, nDictionaryLength] = DCONV_convertDataset_RAE_Bare();
...
%     
	...
	switch(CONFIG_strParams.eClassifierType)
        case 'RAE_Bare'
            LM_startLearningProcessRAE_Bare(cData, cKids, cUnsupervisedData, cUnsupervisedKids, nDictionaryLength);
