...
% read in polarity dataset
if ~exist(preProFile_Qalb,'file')
    read_rtPolarity_Qalb
else
    load(preProFile_Qalb,'We2','allSNum_Qalb');
end

sent_freq_We = ones(length(allSNum_Qalb),1);
[~,dictionary_length] = size(We2);
